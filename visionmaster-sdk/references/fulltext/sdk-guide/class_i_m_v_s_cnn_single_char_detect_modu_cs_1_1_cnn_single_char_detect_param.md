<!-- src:class_i_m_v_s_cnn_single_char_detect_modu_cs_1_1_cnn_single_char_detect_param.html -->
<!-- path:接口函数 > 识别 > DL单字符检测GPU > CnnSingleCharDetectParam -->
# CnnSingleCharDetectParam类 参考 识别 » DL单字符检测GPU
...
|  | 输入图像 更多... |
|  | |
| CnnSingleCharDetectRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
