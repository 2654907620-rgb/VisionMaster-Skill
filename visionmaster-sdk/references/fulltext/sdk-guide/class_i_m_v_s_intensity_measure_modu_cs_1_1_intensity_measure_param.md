<!-- src:class_i_m_v_s_intensity_measure_modu_cs_1_1_intensity_measure_param.html -->
<!-- path:接口函数 > 测量 > 亮度测量 > IntensityMeasureParam -->
# IntensityMeasureParam类 参考 测量 » 亮度测量
...
|  | 输入图像 更多... |
|  | |
| IntensityMeasureRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
