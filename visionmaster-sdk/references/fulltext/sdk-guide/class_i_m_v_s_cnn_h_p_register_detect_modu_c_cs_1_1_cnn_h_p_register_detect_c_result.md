<!-- src:class_i_m_v_s_cnn_h_p_register_detect_modu_c_cs_1_1_cnn_h_p_register_detect_c_result.html -->
<!-- path:接口函数 > 边缘学习 > 全监督检测CPU > CnnHPRegisterDetectCResult -->
# CnnHPRegisterDetectCResult类 参考 边缘学习 » 全监督检测CPU
