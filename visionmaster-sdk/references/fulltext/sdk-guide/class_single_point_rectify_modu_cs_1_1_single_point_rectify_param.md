<!-- src:class_single_point_rectify_modu_cs_1_1_single_point_rectify_param.html -->
<!-- path:接口函数 > 运算 > 单点纠偏 > SinglePointRectifyParam -->
# SinglePointRectifyParam类 参考 运算 » 单点纠偏
