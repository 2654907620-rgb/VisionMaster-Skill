<!-- src:class_i_m_v_s_cnn_h_p_register_detect_modu_c_cs_1_1_cnn_h_p_register_detect_c_param.html -->
<!-- path:接口函数 > 边缘学习 > 全监督检测CPU > CnnHPRegisterDetectCParam -->
# CnnHPRegisterDetectCParam类 参考 边缘学习 » 全监督检测CPU
...
|  | 输入图像 更多... |
|  | |
| CnnHPRegisterDetectCRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
