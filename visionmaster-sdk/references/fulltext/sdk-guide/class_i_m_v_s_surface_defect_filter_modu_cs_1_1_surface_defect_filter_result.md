<!-- src:class_i_m_v_s_surface_defect_filter_modu_cs_1_1_surface_defect_filter_result.html -->
<!-- path:接口函数 > 缺陷检测 > 表面缺陷滤波 > SurfaceDefectFilterResult -->
# SurfaceDefectFilterResult类 参考 缺陷检测 » 表面缺陷滤波
