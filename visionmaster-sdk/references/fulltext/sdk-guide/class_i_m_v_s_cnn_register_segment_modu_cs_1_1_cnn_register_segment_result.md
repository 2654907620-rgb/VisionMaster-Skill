<!-- src:class_i_m_v_s_cnn_register_segment_modu_cs_1_1_cnn_register_segment_result.html -->
<!-- path:接口函数 > 边缘学习 > 注册分割GPU > CnnRegisterSegmentResult -->
# CnnRegisterSegmentResult类 参考 边缘学习 » 注册分割GPU
