<!-- src:class_i_m_v_s_circle_edge_pair_insp_modu_cs_1_1_circle_edge_pair_insp_result.html -->
<!-- path:接口函数 > 缺陷检测 > 圆弧对缺陷检测 > CircleEdgePairInspResult -->
# CircleEdgePairInspResult类 参考 缺陷检测 » 圆弧对缺陷检测
