<!-- src:class_i_m_v_s_cnn_register_multiclass_classification_modu_cs_1_1_cnn_register_multiclass_classification_param.html -->
<!-- path:接口函数 > 边缘学习 > 多类别分类GPU > CnnRegisterMulticlassClassificationParam -->
# CnnRegisterMulticlassClassificationParam类 参考 边缘学习 » 多类别分类GPU
...
|  | 输入图像 更多... |
|  | |
| CnnRegisterMulticlassClassificationRoiManager | ModuRoiManager `[get, set]` |
|  | ROI管理器 更多... |
|  | |
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | CnnRegisterMulticlassClassificationRoiManager ModuRoiManager | | getset |
