<!-- src:class_i_m_v_s_cnn_single_char_detect_modu_c_cs_1_1_cnn_single_char_detect_c_result.html -->
<!-- path:接口函数 > 识别 > DL单字符检测CPU > CnnSingleCharDetectCResult -->
# CnnSingleCharDetectCResult类 参考 识别 » DL单字符检测CPU
