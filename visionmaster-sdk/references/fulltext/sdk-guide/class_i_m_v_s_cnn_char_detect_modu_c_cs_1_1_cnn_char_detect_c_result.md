<!-- src:class_i_m_v_s_cnn_char_detect_modu_c_cs_1_1_cnn_char_detect_c_result.html -->
<!-- path:接口函数 > 识别 > DL字符定位CPU > CnnCharDetectCResult -->
# CnnCharDetectCResult类 参考 识别 » DL字符定位CPU
