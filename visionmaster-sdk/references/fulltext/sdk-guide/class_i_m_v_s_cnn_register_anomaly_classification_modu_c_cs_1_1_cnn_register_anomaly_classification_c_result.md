<!-- src:class_i_m_v_s_cnn_register_anomaly_classification_modu_c_cs_1_1_cnn_register_anomaly_classification_c_result.html -->
<!-- path:接口函数 > 边缘学习 > 异常分类CPU > CnnRegisterAnomalyClassificationCResult -->
# CnnRegisterAnomalyClassificationCResult类 参考 边缘学习 » 异常分类CPU
