<!-- src:class_i_m_v_s_cnn_register_object_count_modu_cs_1_1_cnn_register_object_count_param.html -->
<!-- path:接口函数 > 边缘学习 > 学习计数GPU > CnnRegisterObjectCountParam -->
# CnnRegisterObjectCountParam类 参考 边缘学习 » 学习计数GPU
...
|  | 输入图像 更多... |
|  | |
| CnnRegisterObjectCountRoiManager | ModuRoiManager `[get, set]` |
|  | ROI管理器 更多... |
|  | |
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | CnnRegisterObjectCountRoiManager ModuRoiManager | | getset |
