<!-- src:class_i_m_v_s_cnn_register_anomaly_classification_modu_cs_1_1_cnn_register_anomaly_classification_param.html -->
<!-- path:接口函数 > 边缘学习 > 异常分类GPU > CnnRegisterAnomalyClassificationParam -->
# CnnRegisterAnomalyClassificationParam类 参考 边缘学习 » 异常分类GPU
...
|  | 输入图像 更多... |
|  | |
| CnnRegisterAnomalyClassificationRoiManager | ModuRoiManager `[get, set]` |
|  | ROI管理器 更多... |
|  | |
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | CnnRegisterAnomalyClassificationRoiManager ModuRoiManager | | getset |
