<!-- src:class_i_m_v_s_h_p_feature_match_modu_cs_1_1_h_p_feature_match_param.html -->
<!-- path:接口函数 > 定位 > 高精度匹配 > HPFeatureMatchParam -->
# HPFeatureMatchParam类 参考 定位 » 高精度匹配
...
|  | 输入图像 更多... |
|  | |
| HPFeatureMatchRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
