<!-- src:class_i_m_v_s_binary_modu_cs_1_1_image_binary_result.html -->
<!-- path:接口函数 > 图像处理 > 图像二值化 > ImageBinaryResult -->
# ImageBinaryResult类 参考 图像处理 » 图像二值化
...
|  | 检测区域 更多... |
|  | |
| List< RectBox > | ROIsBox `[get]` |
|  | 检测区域 更多... |
|  | |
| Annulus | ROIAnnulus `[get]` |
|  | ROI圆弧 更多... |
|  | |
| List< Annulus > | ROIAnnuluss `[get]` |
|  | ROI圆弧 更多... |
|  | |
