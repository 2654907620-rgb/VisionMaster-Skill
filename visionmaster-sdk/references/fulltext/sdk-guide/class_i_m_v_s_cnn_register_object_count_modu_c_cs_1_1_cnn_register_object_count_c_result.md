<!-- src:class_i_m_v_s_cnn_register_object_count_modu_c_cs_1_1_cnn_register_object_count_c_result.html -->
<!-- path:接口函数 > 边缘学习 > 学习计数CPU > CnnRegisterObjectCountCResult -->
# CnnRegisterObjectCountCResult类 参考 边缘学习 » 学习计数CPU
