<!-- src:class_i_m_v_s_cnn_h_p_register_detect_modu_cs_1_1_cnn_h_p_register_detect_param.html -->
<!-- path:接口函数 > 边缘学习 > 全监督检测GPU > CnnHPRegisterDetectParam -->
# CnnHPRegisterDetectParam类 参考 边缘学习 » 全监督检测GPU
...
|  | 输入图像 更多... |
|  | |
| CnnHPRegisterDetectRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
