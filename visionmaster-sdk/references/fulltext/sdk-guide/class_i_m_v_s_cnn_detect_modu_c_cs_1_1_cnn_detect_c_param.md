<!-- src:class_i_m_v_s_cnn_detect_modu_c_cs_1_1_cnn_detect_c_param.html -->
<!-- path:接口函数 > 深度学习 > DL目标检测CPU > CnnDetectCParam -->
# CnnDetectCParam类 参考 深度学习 » DL目标检测CPU
...
|  | 输入图像 更多... |
|  | |
| CnnDetectCRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
