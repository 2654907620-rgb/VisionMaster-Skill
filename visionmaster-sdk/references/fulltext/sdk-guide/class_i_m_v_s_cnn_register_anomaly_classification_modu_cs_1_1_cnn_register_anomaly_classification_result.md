<!-- src:class_i_m_v_s_cnn_register_anomaly_classification_modu_cs_1_1_cnn_register_anomaly_classification_result.html -->
<!-- path:接口函数 > 边缘学习 > 异常分类GPU > CnnRegisterAnomalyClassificationResult -->
# CnnRegisterAnomalyClassificationResult类 参考 边缘学习 » 异常分类GPU
