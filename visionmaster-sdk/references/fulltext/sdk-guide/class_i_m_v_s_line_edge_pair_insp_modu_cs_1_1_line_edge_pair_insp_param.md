<!-- src:class_i_m_v_s_line_edge_pair_insp_modu_cs_1_1_line_edge_pair_insp_param.html -->
<!-- path:接口函数 > 缺陷检测 > 直线对缺陷检测 > LineEdgePairInspParam -->
# LineEdgePairInspParam类 参考 缺陷检测 » 直线对缺陷检测
...
|  | 标准输入 更多... |
|  | |
| LineEdgePairInspRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
