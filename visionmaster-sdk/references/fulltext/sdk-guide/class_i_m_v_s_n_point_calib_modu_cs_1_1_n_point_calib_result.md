<!-- src:class_i_m_v_s_n_point_calib_modu_cs_1_1_n_point_calib_result.html -->
<!-- path:接口函数 > 标定 > N点标定 > NPointCalibResult -->
# NPointCalibResult类 参考 标定 » N点标定
...
|  | 标定点总数 更多... |
|  | |
| PointF | CalibImagePoint `[get]` |
|  | 标定图像点 更多... |
|  | |
| PointF | CalibPhysicalPoint `[get]` |
|  | 标定物理点 更多... |
|  | |
