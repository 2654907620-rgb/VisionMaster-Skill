<!-- src:class_i_m_v_s_cnn_register_presence_detect_modu_cs_1_1_cnn_register_presence_detect_result.html -->
<!-- path:接口函数 > 边缘学习 > 有无检测GPU > CnnRegisterPresenceDetectResult -->
# CnnRegisterPresenceDetectResult类 参考 边缘学习 » 有无检测GPU
