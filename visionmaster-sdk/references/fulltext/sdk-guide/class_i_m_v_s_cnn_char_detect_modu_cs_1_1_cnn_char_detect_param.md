<!-- src:class_i_m_v_s_cnn_char_detect_modu_cs_1_1_cnn_char_detect_param.html -->
<!-- path:接口函数 > 识别 > DL字符定位GPU > CnnCharDetectParam -->
# CnnCharDetectParam类 参考 识别 » DL字符定位GPU
...
|  | 输入图像 更多... |
|  | |
| CnnCharDetectRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
