<!-- src:class_i_m_v_s_mark_find_modu_cs_1_1_mark_find_param.html -->
<!-- path:接口函数 > 定位 > 图形定位 > MarkFindParam -->
# MarkFindParam类 参考 定位 » 图形定位
...
|  | 匹配极性 更多... |
|  | |
| enum | MarkLocationTypeEnum {     No = 0x0,     Yes = 0x1   } |
|  | 定位类型 更多... |
|  | |
...
|  | 输入图像 更多... |
|  | |
| MarkFindRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
...
|  | 尺度范围（弃用），范围：[0.1,10] , Range:[0.1,10] 更多... |
|  | |
| double | ScaleEnd `[get, set]` |
|  | 尺度范围（弃用），范围：[0.1,10] , Range:[0.1,10] 更多... |
|  | |
| MarkLocationTypeEnum | MarkLocationType `[get, set]` |
|  | 定位类型 更多... |
|  | |
| double | ScaleXStart `[get, set]` |
|  | X尺度范围（弃用），范围：[0.1,10] , Range:[0.1,10] 更多... |
|  | |
| double | ScaleXEnd `[get, set]` |
|  | X尺度范围（弃用），范围：[0.1,10] , Range:[0.1,10] 更多... |
|  | |
| double | ScaleYStart `[get, set]` |
|  | Y尺度范围（弃用），范围：[0.1,10] , Range:[0.1,10] 更多... |
|  | |
...
|  | 角度范围，范围：[-180,180] 更多... |
|  | |
| bool | ScaleXLimitEnable `[get, set]` |
|  | X尺度判断（弃用） 更多... |
|  | |
| double | ScaleXLimitLow `[get, set]` |
|  | X尺度范围（弃用），范围：[0.0,10] , Range:[0.0,10] 更多... |
|  | |
| double | ScaleXLimitHigh `[get, set]` |
|  | X尺度范围（弃用），范围：[0.0,10] , Range:[0.0,10] 更多... |
|  | |
| bool | ScaleYLimitEnable `[get, set]` |
|  | Y尺度判断（弃用） 更多... |
|  | |
| double | ScaleYLimitLow `[get, set]` |
|  | Y尺度范围（弃用），范围：[0,10] , Range:[0,10] 更多... |
|  | |
| double | ScaleYLimitHigh `[get, set]` |
|  | Y尺度范围（弃用），范围：[0,10] , Range:[0,10] 更多... |
|  | |
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | enum MarkLocationTypeEnum | | strong |
...
尺度范围（弃用），范围：[0.1,10] , Range:[0.1,10]
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | MarkLocationTypeEnum MarkLocationType | | getset |
...
X尺度范围（弃用），范围：[0.1,10] , Range:[0.1,10]
...
Y尺度范围（弃用），范围：[0.1,10] , Range:[0.1,10]
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | double ScaleXLimitLow | | getset |

X尺度范围（弃用），范围：[0.0,10] , Range:[0.0,10]

## ◆ ScaleXLimitHigh

|  |  |  |
| --- | --- | --- |
| |  | | --- | | double ScaleXLimitHigh | | getset |
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | double ScaleYLimitLow | | getset |

Y尺度范围（弃用），范围：[0,10] , Range:[0,10]

## ◆ ScaleYLimitHigh

|  |  |  |
| --- | --- | --- |
| |  | | --- | | double ScaleYLimitHigh | | getset |
