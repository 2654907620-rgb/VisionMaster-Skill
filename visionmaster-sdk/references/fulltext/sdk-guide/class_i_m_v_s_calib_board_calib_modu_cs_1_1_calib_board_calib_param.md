<!-- src:class_i_m_v_s_calib_board_calib_modu_cs_1_1_calib_board_calib_param.html -->
<!-- path:接口函数 > 标定 > 标定板标定 > CalibBoardCalibParam -->
# CalibBoardCalibParam类 参考 标定 » 标定板标定
...
| --- | --- |
| Public 类型 | |
| enum | CoordinateModeEnum {     CoordinateModeLeft = 0x1,     CoordinateModeRight = 0x2   } |
|  | 坐标系模式 更多... |
|  | |
...
|  | 原点(X)，范围：[-1000.0,1000.0] , Range:[-1000.0,1000.0] 更多... |
|  | |
| double | OriginY `[get, set]` |
|  | 原点(Y)，范围：[-1000.0,1000.0] , Range:[-1000.0,1000.0] 更多... |
|  | |
| double | RotationAngle `[get, set]` |
|  | 旋转角度，范围：[-180.0,180.0] 更多... |
|  | |
| CoordinateModeEnum | CoordinateMode `[get, set]` |
|  | 坐标系模式 更多... |
|  | |
| double | PhysicalSize `[get, set]` |
|  | 物理尺寸，范围：[0.01,1000.0] 更多... |
|  | |
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | enum CoordinateModeEnum | | strong |

坐标系模式

| 枚举值 | |
| --- | --- |
| CoordinateModeLeft | 左手坐标系 |
| CoordinateModeRight | 右手坐标系 |
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | double OriginX | | getset |

原点(X)，范围：[-1000.0,1000.0] , Range:[-1000.0,1000.0]

## ◆ OriginY

|  |  |  |
| --- | --- | --- |
| |  | | --- | | double OriginY | | getset |

原点(Y)，范围：[-1000.0,1000.0] , Range:[-1000.0,1000.0]

## ◆ RotationAngle

|  |  |  |
| --- | --- | --- |
| |  | | --- | | double RotationAngle | | getset |
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | CoordinateModeEnum CoordinateMode | | getset |
