<!-- src:class_i_m_v_s_cnn_register_classify_modu_c_cs_1_1_cnn_register_classify_c_param.html -->
<!-- path:接口函数 > 边缘学习 > 注册分类CPU > CnnRegisterClassifyCParam -->
# CnnRegisterClassifyCParam类 参考 边缘学习 » 注册分类CPU
...
|  | 输入图像 更多... |
|  | |
| CnnRegisterClassifyCRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
| int | TopClsK `[get, set]` |
|  | 前K个类别，范围：[1,10] 更多... |
