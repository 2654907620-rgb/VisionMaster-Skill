<!-- src:class_if_module_cs_1_1_if_param-members.html -->
# IfParam 成员列表

成员的完整列表，这些成员属于 IfParam,包括所有继承而来的类成员

|  |  |  |
| --- | --- | --- |
| GetBinaryData(String strName, IntPtr pBinData, uint nMemSize, ref uint nDataLen) | CModuleParamBase |  |
| GetDynamicParam(String strName) | IfParam |  |
| GetIfItemParam(string strName) | IfParam |  |
| GetParamValue(String strName, ref String strValue) | CModuleParamBase |  |
| LogicalMode | IfParam |  |
| LogicalModeEnum 枚举名称 | IfParam |  |
