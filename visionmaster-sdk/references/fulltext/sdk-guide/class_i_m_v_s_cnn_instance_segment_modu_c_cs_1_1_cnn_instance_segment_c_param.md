<!-- src:class_i_m_v_s_cnn_instance_segment_modu_c_cs_1_1_cnn_instance_segment_c_param.html -->
<!-- path:接口函数 > 深度学习 > DL实例分割CPU > CnnInstanceSegmentCParam -->
# CnnInstanceSegmentCParam类 参考 深度学习 » DL实例分割CPU
...
|  | 输入图像 更多... |
|  | |
| CnnInstanceSegmentCRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
