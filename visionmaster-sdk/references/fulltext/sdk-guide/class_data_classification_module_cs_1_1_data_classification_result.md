<!-- src:class_data_classification_module_cs_1_1_data_classification_result.html -->
<!-- path:接口函数 > 逻辑工具 > 数据分类 > DataClassificationResult -->
# DataClassificationResult类 参考 逻辑工具 » 数据分类
