<!-- src:class_i_m_v_s_cnn_register_segment_modu_c_cs_1_1_cnn_register_segment_c_param.html -->
<!-- path:接口函数 > 边缘学习 > 注册分割CPU > CnnRegisterSegmentCParam -->
# CnnRegisterSegmentCParam类 参考 边缘学习 » 注册分割CPU
...
|  | 输入图像 更多... |
|  | |
| CnnRegisterSegmentCRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
