<!-- src:class_i_m_v_s_matrix_circle_find_modu_cs_1_1_matrix_circle_find_param.html -->
<!-- path:接口函数 > 定位 > 阵列圆查找 > MatrixCircleFindParam -->
# MatrixCircleFindParam类 参考 定位 » 阵列圆查找
...
|  | 输入图像 更多... |
|  | |
| MatrixCircleFindRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
...
|  | 拟合方式 更多... |
|  | |
| bool | OutputCoutourPoint `[get, set]` |
|  | 输出轮廓点 更多... |
|  | |
...
|  | 半径判断，范围：[0,99999] 更多... |
|  | |
| bool | OutputCircleNumEnable `[get, set]` |
|  | 圆个数判断 更多... |
|  | |
| int | OutputCircleNumLimitLow `[get, set]` |
|  | 圆个数判断，范围：[1,25] 更多... |
|  | |
| int | OutputCircleNumLimitHigh `[get, set]` |
|  | 圆个数判断，范围：[1,25] 更多... |
|  | |
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | bool OutputCoutourPoint | | getset |
...
## ◆ OutputCircleNumEnable

|  |  |  |
| --- | --- | --- |
| |  | | --- | | bool OutputCircleNumEnable | | getset |

圆个数判断

## ◆ OutputCircleNumLimitLow

|  |  |  |
| --- | --- | --- |
| |  | | --- | | int OutputCircleNumLimitLow | | getset |

圆个数判断，范围：[1,25]

## ◆ OutputCircleNumLimitHigh

|  |  |  |
| --- | --- | --- |
| |  | | --- | | int OutputCircleNumLimitHigh | | getset |
