<!-- src:class_i_m_v_s_color_segment_modu_cs_1_1_color_segment_param-members.html -->
# ColorSegmentParam 成员列表

成员的完整列表，这些成员属于 ColorSegmentParam,包括所有继承而来的类成员

|  |  |  |
| --- | --- | --- |
| AreaLimitEnable | ColorSegmentParam |  |
| AreaLimitHigh | ColorSegmentParam |  |
| AreaLimitLow | ColorSegmentParam |  |
| ClutterArea | ColorSegmentParam |  |
...
| HoleArea | ColorSegmentParam |  |
| InputImage | ColorSegmentParam |  |
| ModuRoiManager | ColorSegmentParam |  |
