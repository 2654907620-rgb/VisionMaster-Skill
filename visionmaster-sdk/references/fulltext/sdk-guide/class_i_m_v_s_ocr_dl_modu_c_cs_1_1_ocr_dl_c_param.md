<!-- src:class_i_m_v_s_ocr_dl_modu_c_cs_1_1_ocr_dl_c_param.html -->
<!-- path:接口函数 > 识别 > DL字符识别CPU > OcrDlCParam -->
# OcrDlCParam类 参考 识别 » DL字符识别CPU
...
|  | 输入图像 更多... |
|  | |
| OcrDlCRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
