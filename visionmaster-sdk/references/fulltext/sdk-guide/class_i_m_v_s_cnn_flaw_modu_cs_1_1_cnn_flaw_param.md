<!-- src:class_i_m_v_s_cnn_flaw_modu_cs_1_1_cnn_flaw_param.html -->
<!-- path:接口函数 > 深度学习 > DL图像分割GPU > CnnFlawParam -->
# CnnFlawParam类 参考 深度学习 » DL图像分割GPU
...
|  | 输入图像 更多... |
|  | |
| CnnFlawRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
