<!-- src:class_i_m_v_s_cnn_register_multiclass_classification_modu_c_cs_1_1_result_filter_item_param.html -->
<!-- path:接口函数 > 边缘学习 > 多类别分类CPU > ResultFilterItemParam -->
# ResultFilterItemParam类 参考 边缘学习 » 多类别分类CPU
