<!-- src:class_i_m_v_s_circle_edge_insp_modu_cs_1_1_circle_edge_insp_param.html -->
<!-- path:接口函数 > 缺陷检测 > 圆弧边缘缺陷检测 > CircleEdgeInspParam -->
# CircleEdgeInspParam类 参考 缺陷检测 » 圆弧边缘缺陷检测
...
|  | 输入图像 更多... |
|  | |
| List< Annulus > | InputAnnulus `[set]` |
|  | 输入圆弧 更多... |
|  | |
| bool | StandardInput `[get, set]` |
|  | 标准输入 更多... |
|  | |
| CircleEdgeInspRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
