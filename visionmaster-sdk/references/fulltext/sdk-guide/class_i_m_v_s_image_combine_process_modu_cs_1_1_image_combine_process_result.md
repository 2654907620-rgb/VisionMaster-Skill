<!-- src:class_i_m_v_s_image_combine_process_modu_cs_1_1_image_combine_process_result.html -->
<!-- path:接口函数 > 图像处理 > 图像组合 > ImageCombineProcessResult -->
# ImageCombineProcessResult类 参考 图像处理 » 图像组合
