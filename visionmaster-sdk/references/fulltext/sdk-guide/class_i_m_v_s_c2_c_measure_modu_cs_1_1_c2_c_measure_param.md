<!-- src:class_i_m_v_s_c2_c_measure_modu_cs_1_1_c2_c_measure_param.html -->
<!-- path:接口函数 > 测量 > 圆圆测量 > C2CMeasureParam -->
# C2CMeasureParam类 参考 测量 » 圆圆测量
...
|  | 输出角度范围 更多... |
|  | |
| enum | FindMode1Enum {     Best = 0x1,     Largest = 0x2,     Smallest = 0x3   } |
|  | 边缘类型1 更多... |
|  | |
...
|  | 输入图像 更多... |
|  | |
| List< Annulus > | InputCircleAnnulus1 `[set]` |
|  | 输入圆1 更多... |
|  | |
| List< Annulus > | InputCircleAnnulus2 `[set]` |
|  | 输入圆2 更多... |
|  | |
...
|  | 边缘极性1 更多... |
|  | |
| int | EdgeThresh1 `[get, set]` |
|  | 边缘阈值1，范围：[0,255] 更多... |
|  | |
| int | EdgeWidth1 `[get, set]` |
|  | 滤波尺寸1，范围：[1,50] 更多... |
|  | |
| int | RejectNum1 `[get, set]` |
|  | 剔除点数1，范围：[0,997] 更多... |
|  | |
| bool | CoarseDetectFlag1 `[get, set]` |
|  | 初定位1 更多... |
|  | |
| int | CCDSampleScale1 `[get, set]` |
|  | 下采样系数1，范围：[1,8] 更多... |
|  | |
| int | CCDCircleThresh1 `[get, set]` |
|  | 定位敏感度1，范围：[1,1000] 更多... |
|  | |
