<!-- src:class_i_m_v_s_cnn_code_recg_modu_c_cs_1_1_cnn_code_recg_c_param.html -->
<!-- path:接口函数 > 识别 > DL读码CPU > CnnCodeRecgCParam -->
# CnnCodeRecgCParam类 参考 识别 » DL读码CPU
...
|  | 输入图像 更多... |
|  | |
| CnnCodeRecgCRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
| bool | CODE39 `[get, set]` |
|  | CODE39码 更多... |
