<!-- src:class_i_m_v_s_contour_match_modu_cs_1_1_contour_match_param.html -->
<!-- path:接口函数 > 定位 > 轮廓匹配 > ContourMatchParam -->
# ContourMatchParam类 参考 定位 » 轮廓匹配
...
|  | 阈值类型 更多... |
|  | |
| enum | NMSSortTypeEnum {     Score = 0x2,     Angle = 0x3,     X = 0x4,     Y = 0x5,     XY = 0x6,     YX = 0x7   } |
|  | 多模板排序方式 更多... |
|  | |
...
|  | 输入图像 更多... |
|  | |
| ContourMatchRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
| bool | UseMatchAllMode `[get, set]` |
|  | 全部搜索模式 更多... |
|  | |
| int | MultiModelMaxOverlap `[get, set]` |
|  | 多模板重叠率，范围：[0,100] 更多... |
|  | |
...
|  | Y尺度范围，范围：[0.1,10] 更多... |
|  | |
| int | SkewXStart `[get, set]` |
|  | 横切角度范围，范围：[-45,45] 更多... |
|  | |
| int | SkewXEnd `[get, set]` |
|  | 横切角度范围，范围：[-45,45] 更多... |
|  | |
...
|  | 轮廓使能 更多... |
|  | |
| bool | OutLinePointEnable `[get, set]` |
|  | 轮廓点使能 更多... |
|  | |
...
|  | 中心点Y范围，范围：[-99999,99999] 更多... |
|  | |
| int | NMSMaxOverlap `[get, set]` |
|  | 多模板重叠率（废弃），范围：[0,100] 更多... |
|  | |
| NMSSortTypeEnum | NMSSortType `[get, set]` |
|  | 多模板排序方式（废弃） 更多... |
|  | |
...
## ◆ MultiModelMaxOverlap

|  |  |  |
| --- | --- | --- |
| |  | | --- | | int MultiModelMaxOverlap | | getset |
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | bool OutLinePointEnable | | getset |
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | NMSSortTypeEnum NMSSortType | | getset |
