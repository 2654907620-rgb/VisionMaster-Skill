<!-- src:class_i_m_v_s_cnn_classify_modu_c_cs_1_1_cnn_classify_c_param.html -->
<!-- path:接口函数 > 深度学习 > DL分类CPU > CnnClassifyCParam -->
# CnnClassifyCParam类 参考 深度学习 » DL分类CPU
...
|  | 输入图像 更多... |
|  | |
| CnnClassifyCRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
