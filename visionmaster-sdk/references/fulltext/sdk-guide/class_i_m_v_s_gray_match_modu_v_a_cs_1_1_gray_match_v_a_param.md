<!-- src:class_i_m_v_s_gray_match_modu_v_a_cs_1_1_gray_match_v_a_param.html -->
<!-- path:接口函数 > 定位 > 灰度匹配VA > GrayMatchVAParam -->
# GrayMatchVAParam类 参考 定位 » 灰度匹配VA
...
|  | 排序类型 更多... |
|  | |
| enum | MatchingPolarityEnum {     No = 0x0,     Yes = 0x1   } |
|  | 匹配极性 更多... |
|  | |
...
|  | 输入图像 更多... |
|  | |
| GrayMatchVARoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
...
|  | 匹配极性，范围：[0,1] 更多... |
|  | |
| MatchingPolarityEnum | MatchingPolarity `[get, set]` |
|  | 匹配极性 更多... |
|  | |
| int | TimeOut `[get, set]` |
|  | 超时控制，范围：[0,10000] 更多... |
|  | |
| int | EndPyramidLevel `[get, set]` |
|  | 匹配结束层，范围：[0,8] 更多... |
|  | |
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | enum MatchingPolarityEnum | | strong |
...
|  |  |  |
| --- | --- | --- |
| |  | | --- | | MatchingPolarityEnum MatchingPolarity | | getset |
