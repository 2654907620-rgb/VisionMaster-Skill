<!-- src:class_i_m_v_s_cnn_register_detect_modu_c_cs_1_1_cnn_register_detect_c_param.html -->
<!-- path:接口函数 > 边缘学习 > 注册检测CPU > CnnRegisterDetectCParam -->
# CnnRegisterDetectCParam类 参考 边缘学习 » 注册检测CPU
...
|  | 输入图像 更多... |
|  | |
| CnnRegisterDetectCRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
...
|  | |
| double | MaxCoverage `[get, set]` |
|  | 最大覆盖率，范围：[0.01,1.0] 更多... |
|  | |
