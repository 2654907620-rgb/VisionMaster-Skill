<!-- src:class_i_m_v_s_cnn_char_detect_modu_c_cs_1_1_cnn_char_detect_c_param.html -->
<!-- path:接口函数 > 识别 > DL字符定位CPU > CnnCharDetectCParam -->
# CnnCharDetectCParam类 参考 识别 » DL字符定位CPU
...
|  | 输入图像 更多... |
|  | |
| CnnCharDetectCRoiManager | ModuRoiManager `[get]` |
|  | ROI管理器 更多... |
|  | |
...
|  | 最小置信度，范围：[0.01,1.0]（弃用） 更多... |
|  | |
| double | BoxScore `[get, set]` |
|  | 最小分数，范围：[0.01,1.0] 更多... |
|  | |
| double | MaxOverlap `[get, set]` |
|  | 最大重叠率，范围：[0.01,1.0] 更多... |
|  | |
| double | LinkThreshold `[get, set]` |
|  | 链接阈值，范围：[0.01,1.0] 更多... |
|  | |
| SortObjectModeEnum | SortObjectMode `[get, set]` |
|  | 目标排序 更多... |
|  | |
| double | ShrinkBack `[get, set]` |
|  | 缩放系数，范围：[0.01,2.0] 更多... |
|  | |
...
|  | |
| bool | TextComparisonEnable `[get, set]` |
|  | 文本对比 更多... |
|  | |
...
最小置信度，范围：[0.01,1.0]（弃用）

## ◆ BoxScore

|  |  |  |
| --- | --- | --- |
| |  | | --- | | double BoxScore | | getset |
...
## ◆ TextComparisonEnable

|  |  |  |
| --- | --- | --- |
| |  | | --- | | bool TextComparisonEnable | | getset |
