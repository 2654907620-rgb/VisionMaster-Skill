<!-- src:class_procedure_1_1_procedure_result.html -->
<!-- path:接口函数 > 流程 > ProcedureResult -->
# ProcedureResult类 参考 流程
...
|  | 整型结果（结果为空时nValueNum为0且pIntVal和nReserved为null） 更多... |
|  | |
...
整型结果（结果为空时nValueNum为0且pIntVal和nReserved为null）
